...
## Digital Asset Management - Embed Metadata and Copyright Info on each Product Image Guidelines

[**Brandfolder**](https://brandfolder.com/about "Brandfolder is the premier leader in digital asset management. Built for organizations of all sizes and industries, Brandfolder delivers a visually elegant platform that allows you to easily share, store, track, and manipulate your assets. And with the #1 rated support, Brandfolder is the most cost-effective way to build stronger brand engagement.") - Founded in 2012, and located in the heart of Downtown Denver, Brandfolder is the premier leader in digital asset management. Built for organizations of all sizes and industries, Brandfolder delivers a visually elegant platform that allows you to easily share, store, track, and manipulate your assets. And with the #1 rated support, Brandfolder is the most cost-effective way to build stronger brand engagement.

* Digital asset management at its best.
* Enterprise-level identity management, and analytics features.
* **Privacy Control** - Secure public and private control over Brandfolders and curated Collections
* **Asset Storage** - Scalable cloud storage, suited to your organization’s needs
* **Thoughtful Onboarding** - Asset audit and onboarding with a dedicated Brandfolder expert
* **Branded Experience** - Customizable look and feel, domain, and search
* **User Permissions** - Manage a variety of user accounts and permissions

Going Remote in a Hurry - Enabling remote creative work with a DAM - Featuring Kristi Hunter, Spyderco's Digital Media & Marketing Administrator on Wednesday, April 29th at 9am PT / 12pm ET - If you can’t make the live webinar, go ahead and register and we’ll send you the recording afterward! Link - [https://dam.brandfolder.com/going-remote-in-a-hurry-webinar.html?utm_source=resources&utm_medium=website&utm_campaign=brand](https://dam.brandfolder.com/going-remote-in-a-hurry-webinar.html?utm_source=resources&utm_medium=website&utm_campaign=brand "https://dam.brandfolder.com/going-remote-in-a-hurry-webinar.html?utm_source=resources&utm_medium=website&utm_campaign=brand")

[**Workbench**](https://brandfolder.com/workbench-suite "Workbench - Brandfolder") is a free set of tools designed to make some features of a digital asset management (DAM) platform available to everyone. Convert file formats, resize images, auto-tag images with AI, extract text from an image, and even extract metadata. No ads, no pop-ups, free forever.

* **File Converter Tool** - The file converter will allow you to convert jpg to png, png to jpg or another file type. Upload your files and change their file type from your browser, and then download.
* **Text Extractor Tool** - The text extractor will allow you to extract text from any image. You may upload an image or document (.doc, .pdf) and the tool will pull text from the image. Once extracted, you can copy to your clipboard with one click.
* **Resize Images Online** - Resize images without losing quality, while maintaining the aspect ratio to avoid skewing and distorting.
* **Generate a Color Palette Tool** - This simple color palette generator extracts colors from any photo or file on upload. Then just copy the HEX codes from the color palette app with a simple click!
* **Extract Image Metadata Tool** - Extract metadata recorded behind your files, ranging from file size and modification history to the software tools used to create them.
* **Auto-tag with AI Technology Tool** - Discover how AI auto-tagging technology uses image recognition to analyze and generate tags based on objects detected within images.
* **Compare Logos & Other Images** - Want to compare two images? With Brandfolder’s AI you can spot the difference between two images or logos.

## Brandfolder Blog

Brandfolder Blog - **What is Digital Asset Management? by James Winter -** [https://brandfolder.com/blog/what-is-digital-asset-management](https://brandfolder.com/blog/what-is-digital-asset-management "https://brandfolder.com/blog/what-is-digital-asset-management")

* What is a digital asset?
* What are the benefits of Digital Asset Management?
* The 10 Benefits of Digital Asset Management
* Easy integration with Digital Asset Management
* Digital Asset Management Use Cases
* Maintain brand consistency
* Improve analytics, deliver insights
* Keep your assets secure, and more
* Improve collaboration
* Find assets faster
* Faster time-to-market
* Eliminate risks of license non-compliance

[Integrations](https://brandfolder.com/integrations "Brandfolder Integrations") - Whether you want to streamline your workflow, connect to cloud storage, or track events and analytics, Brandfolder’s platform offers many integrations to strengthen your digital asset management capabilities. Find your perfect integration partner below.
...
* **Advanced Filters - Filtering Assets in Asset Library -** 
  * Another example of Advanced Filtering could be - **Orientation**: Horizontal / Vertical / Square / Panoramic
    ...
    * **View Options** - Layout: Grid View / List View
    * **Sort by** - Position / NAME (A-Z) / NAME (Z-A) / Most Popular / Least Popular / Updated (Newest) / Updated (Oldest) / Created (Newest) / Created (Oldest)
    * **Assets per section** 10 / 32 / 75 / 100 / 150 / 300
    * **Show custom fields** - Similar
* **Embed** - Embed this asset - By embedding this link you are acknowledging that it is accessible to anyone from where it is embedded.
  * **Asset CDN** Link - Add URL
  * **Attachment CDN** Link - Add URL
  * **Add CDN documentation** - Add URL for CDN documentation
  * **Select Mode** - AUTO Automatically chooses the best format (WEBP or PNG) to optimize the load time of images based on the users browser.
* **API Usage** - Add URL for API documentation
* Additionally, it would prove beneficial if you can implement - 
  * **Share Search**: Send the link below to someone and they'll see this Asset folder initially filtered for metadata.file_type:"PNG"

**Examples of Metadata used by Slack**

* NAME **Slack_RGB.png**
* FILE TYPE **PNG**
* SIZE **17.1 KB**
* DIMENSIONS **1297 x 531**
* Extracted color palette **#FEFEFE / #000000 / #6D6D6D**
...
* image_size: 1297x531
* filter: Adaptive
* palette: (Binary data 246 bytes, use -b option to extract)
* bit_depth: 8
* file_size: 17 kB
...
* image_width: 1297
* megapixels: 0.689
* modify_date: 2019-01-11 00:04:08 +0000
* pixel_units: meters
* compression: Deflate/Inflate
* image_height: 531
* transparency: (Binary data 76 bytes, use -b option to extract)
* srgb_rendering: Perceptual
* file_access_date: 2020-04-14T19:16:14.000+00:00
* file_modify_date: 2020-04-14T19:16:14.000+00:00
* pixels_per_unit_x: 5905
* pixels_per_unit_y: 5905
* background_color: 0
...
* FILE TYPE EPS
* SIZE 1.7 MB
* DIMENSIONS 2758 x 698
* Extracted color palette #FEFEFE / #000000 / #6D6D6D
* Background color #FEFEFE
* Text from image slack
* software: GPL Ghostscript 9.18
* file_type: PNG
* mime_type: image/png
* image_size: 2758x698
* filter: Adaptive
...
* compression: Deflate/Inflate
* image_height: 698
* file_access_date: 2019-01-11 00:02:08 +0000
* file_modify_date: 2019-01-11 00:02:08 +0000
* pixels_per_unit_x: 15748
* pixels_per_unit_y: 15748
* background_color: 255 255 255
* file_type_extension: png
* file_inode_change_date: 2019-01-11 00:02:08 +0000
    ...
    <x:xmpmeta xmlns:x="adobe:ns:meta/" x:xmptk="Adobe XMP Core 5.6-c143 79.161356, 2017/09/07-01:11:22        ">
       <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
          <rdf:Description rdf:about=""
             ...
             <exif:PixelYDimension>304</exif:PixelYDimension>
             <exif:ColorSpace>65535</exif:ColorSpace>
             <tiff:Orientation>1</tiff:Orientation>
             <tiff:ImageWidth>1200</tiff:ImageWidth>
             <tiff:ImageLength>304</tiff:ImageLength>
             ...
             <tiff:XResolution>157/1</tiff:XResolution>
             <tiff:YResolution>157/1</tiff:YResolution>
             <tiff:ResolutionUnit>3</tiff:ResolutionUnit>
             <xmpMM:DocumentID>CCF2856FFF827ADA3E54471A3DC079F5</xmpMM:DocumentID>
...
* FILE TYPE **JPG**
* SIZE **4.1 MB**
* DIMENSIONS **5465 x 3904**
* Extracted color palette **#C4CCCC / #262D3F / #99ADAD / #6B9196**
...
* image_size: 5465x3904
* rating: 5
* fov: 23.9 deg
* iso: 80
* a_to_b0: (Binary data 29712 bytes, use -b option to extract)
* a_to_b1: (Binary data 436 bytes, use -b option to extract)
* b_to_a0: (Binary data 29748 bytes, use -b option to extract)
* b_to_a1: (Binary data 508 bytes, use -b option to extract)
* flash: On, Return not detected
* dehaze: 0
* format: image/jpeg
* lens_id: AF-S Nikkor 85mm f/1.4G
* red_hue: 0
* blue_hue: 0
* f_number: 3.2
* version: 10.4
...
* file_size: 4.7 MB
* green_hue: 0
* lens_info: 85mm f/1.4
* vibrance: 0
* lens_model: 85.0 mm f/1.4
* profile_id: 34562abf994ccd066d2c5721d0d68c5d
* scene_type: Directly photographed
* sharpness: Normal
* tone_curve: 0, 0, 255, 255
* blacks2012: 0
* cfa_pattern: \[Red,Green\]\[Green,Blue\]
* color_space: sRGB
* document_id: xmp.did:f0355420-c024-490b-b2e6-daa95701575f
* file_source: Digital Camera
* iptc_digest: 55527324d6c3e6465df1d42d8fdbdabb
* image_width: 5465
* instance_id: xmp.iid:f0355420-c024-490b-b2e6-daa95701575f
* light_value: 11.3
* megapixels: 21.3
* modify_date: 2018-08-21 16:20:41 +0000
* saturation: Normal
* shadow_tint: 0
* whites2012: 0
* xmp_toolkit: Adobe XMP Core 5.6-c140 79.160451, 2017/05/06-01:08:21
* clarity2012: 0
* compression: JPEG (old-style)
* creator_tool: Adobe Photoshop Lightroom Classic 7.4 (Macintosh)
* date_created: 2018-07-23 10:50:36 +0000
* exif_version: 230
* focal_length: 85.0 mm
* gain_control: None
* grain_amount: 0
* has_settings: true
* history_when: 2018:07:23 12:14:15-07:00, 2018:07:23 15:14:38-07:00, 2018:07:25 10:56:21-07:00, 2018:07:25 11:33:22-07:00, 2018:07:25 11:33:22-07:00, 2018:08:21 14:43:25-07:00, 2018:08:21 14:52:25-07:00, 2018:08:21 14:52:25-07:00, 2018:08:21 16:16:55-07:00, 2018:08:21 16:20:41-07:00
* image_height: 3904
* image_number: 55419
* jfif_version: 1.01
* light_source: Fine Weather
* shadows2012: 0
* time_created: 10:50:36
* x_resolution: 240
* y_resolution: 240
* contrast2012: 0
* exposure2012: 0.0
...
* exposure_time: 1/200
* metadata_date: 2018-08-21 16:20:41 -0700
* metering_mode: Multi-segment
* perspective_x: 0.0
* perspective_y: 0.0
* profile_class: ColorSpace Conversion Profile
* serial_number: 3082700
* shutter_speed: 1/200
* tone_curve_red: 0, 0, 255, 255
* white_balance: Manual
* aperture_value: 3.2
* auto_lateral_ca: 0
* bits_per_sample: 8
* camera_profile: Embedded
* exif_byte_order: Little-endian (Intel, II)
* history_action: saved, saved, derived, saved, saved, converted, derived, saved, converted, derived, saved, saved, converted, derived, saved, saved, converted, derived, saved
* red_saturation: 0
* sensing_method: One-chip color area
* sharpen_detail: 25
* sharpen_radius: 1.0
* tone_curve_blue: 0, 0, 255, 255
* tone_curve_name: Linear
* already_applied: true
* blue_saturation: 0
* custom_rendered: Normal
* file_access_date: 2018-10-08 19:51:18 +0000
* file_modify_date: 2018-10-08 19:51:19 +0000
* highlights2012: 0
* history_changed: \["/metadata", "/metadata", "/", "/", "/", "/", "/", "/", "/", "/"\]
* process_version: 10.0
* profile_cmm_type: Unknown ()
* profile_version: 4.2.0
* resolution_unit: inches
* thumbnail_image: (Binary data 10304 bytes, use -b option to extract)
* tone_curve_green: 0, 0, 255, 255
* upright_version: 151388160
* vignette_amount: 0
* color_components: 3
...
* green_saturation: 0
* incremental_tint: 0
* media_white_point: 0.9642 1 0.82491
* parametric_darks: 0
* primary_platform: Unknown ()
* profile_date_time: 2007-07-25 00:05:37 +0000
* rendering_intent: Perceptual
* sensitivity_type: Recommended Exposure Index
* thumbnail_length: 10304
* thumbnail_offset: 11500
* tone_curve_pv2012: 0, 0, 255, 255
* tone_map_strength: 0
* date_time_original: 2018-07-23 10:50:36 +0000
* device_attributes: Reflective, Glossy, Positive, Color
* digital_zoom_ratio: 1
* focal_length35efl: 85.0 mm (35 mm equivalent: 85.0 mm)
* hue_adjustment_red: 0
* lens_profile_setup: LensDefaults
* max_aperture_value: 1.4
* parametric_lights: 0
* perspective_scale: 100
* profile_copyright: Copyright 2007 International Color Consortium
* scale_factor35efl: 1.0
* scene_capture_type: Standard
* upright_focal_mode: 0
* y_cb_cr_sub_sampling: YCbCr4:4:4 (1 1)
* circle_of_confusion: 0.030 mm
* coded_character_set: UTF8
* current_iptc_digest: 55527324d6c3e6465df1d42d8fdbdabb
* file_type_extension: jpg
* history_instance_id: xmp.iid:ee0cbd59-b157-4ede-9f47-720caf056c71, xmp.iid:75505529-2513-4ed3-b7b2-00486ee256fd, xmp.iid:527ef9dc-c78f-4adb-b69a-ed4ae9158ad0, xmp.iid:a5312f79-c3be-4953-a37b-462cab484113, xmp.iid:01634bee-5425-4aaf-a77d-f72876cc4e43, xmp.iid:19816226-3760-4b35-afd7-cf0adca63872, xmp.iid:750be125-7a67-4f63-a375-96120969bd43, xmp.iid:42f23711-8ef5-4e3e-9caa-d4d2e1dbb6b3, xmp.iid:09aca279-0ec3-4265-a5c6-b7fda2399253, xmp.iid:f0355420-c024-490b-b2e6-daa95701575f
* history_parameters: \["converted from image/x-nikon-nef to image/tiff", "from image/tiff to application/vnd.adobe.photoshop", "converted from image/tiff to application/vnd.adobe.photoshop", "from application/vnd.adobe.photoshop to image/vnd.adobe.photoshop", "converted from image/vnd.adobe.photoshop to image/tiff", "from image/tiff to application/vnd.adobe.photoshop", "converted from image/tiff to application/vnd.adobe.photoshop", "from application/vnd.adobe.photoshop to image/vnd.adobe.photoshop", "converted from image/vnd.adobe.photoshop to image/jpeg, saved to new location"\]
* hue_adjustment_aqua: 0
* hue_adjustment_blue: 0
* lens_profile_enable: 0
* parametric_shadows: 0
* perspective_aspect: 0
* perspective_rotate: 0.0
* shutter_speed_value: 1/200
* tone_curve_name2012: Linear
* upright_center_mode: 0
* defringe_green_hue_hi: 60
* defringe_green_hue_lo: 40
* hue_adjustment_green: 0
* hyperfocal_distance: 75.14 m
* luminance_smoothing: 0
* original_document_id: 1E1DBB7EFBF143984948FBCC9EDB867D
* perspective_upright: 0
* photoshop_thumbnail: (Binary data 10304 bytes, use -b option to extract)
* profile_description: sRGB v4 ICC preference perceptual intent beta
* sharpen_edge_masking: 0
* split_toning_balance: 0
* sub_sec_time_original: 49
* tone_curve_pv2012_red: 0, 0, 255, 255
* upright_center_norm_x: 0.5
* upright_center_norm_y: 0.5
* camera_profile_digest: 54650A341B5B5CCAE8442D0B43A92BCE
* chromatic_adaptation: 1.04802 0.02301 -0.05017 0.02972 0.99034 -0.01707 -0.00923 0.01028 0.75214
* color_noise_reduction: 0
* defringe_green_amount: 0
* defringe_purple_hue_hi: 70
* defringe_purple_hue_lo: 30
* digital_creation_date: 2018:07:23
* digital_creation_time: 10:50:36
* file_inode_change_date: 2018-10-08 19:51:19 +0000
* hue_adjustment_orange: 0
* hue_adjustment_purple: 0
* hue_adjustment_yellow: 0
...
* split_toning_shadow_hue: 0
* subject_distance_range: Unknown
* tone_curve_pv2012_green: 0, 0, 255, 255
* derived_from_document_id: adobe:docid:photoshop:db690235-3341-af40-8261-2c46f35d12fd
* derived_from_instance_id: xmp.iid:09aca279-0ec3-4265-a5c6-b7fda2399253
* focal_plane_x_resolution: 1675.014984
* focal_plane_y_resolution: 1675.014984
* parametric_shadow_split: 25
* perspective_horizontal: 0
* upright_transform_count: 6
* incremental_temperature: 0
* luminance_adjustment_red: 0
* parametric_midtone_split: 50
* post_crop_vignette_amount: 0
* profile_connection_space: Lab
* sub_sec_date_time_original: 2018-07-23 10:50:36 +0000
* upright_focal_length35mm: 35
* digital_creation_date_time: 2018-07-23 10:50:36 +0000
* focal_length_in35mm_format: 85 mm
* luminance_adjustment_aqua: 0
* luminance_adjustment_blue: 0
* saturation_adjustment_red: 0
* split_toning_highlight_hue: 0
* application_record_version: 4
* approximate_focus_distance: 2
* focal_plane_resolution_unit: cm
* luminance_adjustment_green: 0
* parametric_highlight_split: 75
* saturation_adjustment_aqua: 0
* saturation_adjustment_blue: 0
* upright_four_segments_count: 0
* connection_space_illuminant: 0.9642 1 0.82491
* luminance_adjustment_orange: 0
* luminance_adjustment_purple: 0
* luminance_adjustment_yellow: 0
* saturation_adjustment_green: 0
* lens_manual_distortion_amount: 0
* luminance_adjustment_magenta: 0
* saturation_adjustment_orange: 0
* saturation_adjustment_purple: 0
* saturation_adjustment_yellow: 0
* saturation_adjustment_magenta: 0
* split_toning_shadow_saturation: 0
* derived_from_original_document_id: 1E1DBB7EFBF143984948FBCC9EDB867D
* perceptual_rendering_intent_gamut: Perceptual Reference Medium Gamut
* split_toning_highlight_saturation: 0
